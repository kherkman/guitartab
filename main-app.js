document.addEventListener('DOMContentLoaded', () => {
    // --- CONSTANTS ---
    // All constants have been moved to constants.js
    ...
    const sazComments = document.getElementById('saz-comments');
    ...
    function renderApp() {
        ...
        sazComments.style.display = (state.temperament === 'saz' || state.temperament === 53) ? 'block' : 'none';
    ...
    function handleSetupChange(e) {
        ...
        switch (setup) {
            ...
            case 'saz_53_edo': setTuning(3, 53, SAZ_TUNING_HZ, SAZ_GAUGES, 53); break;
    ...
    function updateTheoryDefinitions() {
        ...
        if (is12ToneBased) {
            ...
            // --- MODIFIED ---
            const edoSpecificScales = { 19: SCALE_DEFINITIONS_19, 24: SCALE_DEFINITIONS_24, 31: SCALE_DEFINITIONS_31, 53: SCALE_DEFINITIONS_53 };
            // --- NEW ADDITION ---
            if (state.temperament === 24) {
                 Object.assign(edoSpecificScales[24], SCALE_DEFINITIONS_SAZ_24);
            }
    ...
    function updateGlobalControls() { 
        ...
        if (!state.isPlayerVienew) { // In Spectator View, the perspective is flipped
